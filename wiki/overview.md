...
created: 2026-04-08
updated: 2026-04-14
sources: [understanding-the-linux-kernel, linux-kernel-in-a-nutshell, advanced-linux-programming, understanding-linux-network-internals, professional-linux-kernel-architecture, qemu-kvm-source-code-and-application, mastering-kvm-virtualization, debugging-with-gdb, lcna-co2012-sekiyama, minimizing-vmexits-pv-ipi-passthrough-timer, all-solution-vmexit, bytedance-solution-vmexit, bytedance-solution-vmexit-code, vmexit-opt-hitachi-sekiyama, kvm-devirt-kvmforum2022]
tags: [overview]
---
...
- **KVM-devirt** (ByteDance STE, KVM Forum 2022): Zero-overhead partition hypervisor extending KVM for server partitioning (not consolidation). Six techniques eliminate all VM Exits and address translations after guest init: interrupt/IPI/timer passthrough, **memory de-virtualization** (PV page table interfaces eliminating EPT/NPT — largest single gain at 14%), DMA devirtualization (IOMMU passthrough mode), and virtio notification passthrough. Combined 20-30% improvement over standard VM; at 4 partitions, 9% faster than native due to kernel scalability benefits. Supports Intel + AMD, QEMU + Cloud-hypervisor
